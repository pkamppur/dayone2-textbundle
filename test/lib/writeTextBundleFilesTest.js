...
import writeTextBundleFiles from "../../lib/writeTextBundleFiles.js";
import { rimraf } from "rimraf";
import { URL } from "url";

const __dirname = new URL(".", import.meta.url).pathname;
const testSuitePath = `${__dirname}../tmp/writeTextBundleFiles`;

describe("writeTextBundleFiles", () => {
  before(() => {
  ...
  describe("normal", () => {
    it("returns", async () => {
      ...
      writeTextBundleFiles(targetDir, {
